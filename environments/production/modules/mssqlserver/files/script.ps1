...
$FILESHARE="192.168.20.141"
$LOCAL_INSTALLERS_PATH ="C:\tmp"
$FILESHARE_SQLSERVER="SQLServer"
$FILESHARE="\\192.168.20.141\ViewNAS-ISO\ISO\SQL Server\SQL2016\Setup"
$FILESHARE_USERNAME="admin"
$FILE_SERVER="192.168.20.141"
